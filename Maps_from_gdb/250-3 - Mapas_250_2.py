...
matrix_workspaces = [
    ...
    #["F172_Maraba", os.path.join(path_to_gdb, "F172_Maraba_UTM22S"), None, os.path.join(path_local, "LAYOUT_250_172_" + sigla_var + ".mxd"), False],
    #["F173_Imperatriz", os.path.join(path_to_gdb, "F173_Imperatriz_UTM23S"), None, os.path.join(path_local, "LAYOUT_250_173_" + sigla_var + ".mxd"), False],
    #["F199_Xambioa", os.path.join(path_to_gdb, "F199_Xambioa_UTM22S"), None, os.path.join(path_local, "LAYOUT_250_199_" + sigla_var + ".mxd"), False],
    #["F200_Tocantinopolis", os.path.join(path_to_gdb, "F200_Tocantinopolis_UTM23S"), None, os.path.join(path_local, "LAYOUT_250_200_" + sigla_var + ".mxd"), False],
    #["F226_Araguaiana", os.path.join(path_to_gdb, "F226_Araguaiana_UTM22S"), None, os.path.join(path_local, "LAYOUT_250_226_" + sigla_var + ".mxd"), False],
    #["F227_Carolina", os.path.join(path_to_gdb, "F227_Carolina_UTM23S"), os.path.join(path_to_gdb, "F228_Balsas_UTM23S"), os.path.join(path_local, "LAYOUT_250_227_228_" + sigla_var + ".mxd"), True],
    #["F253_Conceicao_do_Araguaia", os.path.join(path_to_gdb, "F253_Conceicao_do_Araguaia_UTM22S"), os.path.join(path_to_gdb, "F252_Redencao_UTM22S"), os.path.join(path_local, "LAYOUT_250_252_253_" + sigla_var + ".mxd"), True],
    #["F254_Itacaja", os.path.join(path_to_gdb, "F254_Itacaja_UTM23S"), os.path.join(path_to_gdb, "F255_Passo_Fragoso_UTM23S"), os.path.join(path_local, "LAYOUT_250_254_255_" + sigla_var + ".mxd"), True],
    #["F278_Santana_do_Araguaia", os.path.join(path_to_gdb, "F278_Santana_do_Araguaia_UTM22S"), None, os.path.join(path_local, "LAYOUT_250_278_" + sigla_var + ".mxd"), False],
    #["F279_Miracema_do_Tocantins", os.path.join(path_to_gdb, "F279_Miracema_do_Tocantins_UTM22S"), None, os.path.join(path_local, "LAYOUT_250_279_" + sigla_var + ".mxd"), False],
    #["F280_Lizarda", os.path.join(path_to_gdb, "F280_Lizarda_UTM23S"), os.path.join(path_to_gdb, "F281_Gilbues_UTM23S"), os.path.join(path_local, "LAYOUT_250_280_281_" + sigla_var + ".mxd"), True],
    #["F303_Santa_Terezinha", os.path.join(path_to_gdb, "F303_Santa_Terezinha_UTM22S"), None, os.path.join(path_local, "LAYOUT_250_303_" + sigla_var + ".mxd"), False],
    #["F304_Porto_Nacional", os.path.join(path_to_gdb, "F304_Porto_Nacional_UTM22S"), None, os.path.join(path_local, "LAYOUT_250_304_" + sigla_var + ".mxd"), False],
    #["F305_Ponte_Alta_do_Norte", os.path.join(path_to_gdb, "F305_Ponte_Alta_do_Norte_UTM23S"), None, os.path.join(path_local, "LAYOUT_250_305_" + sigla_var + ".mxd"), False],
    #["F306_Corrente", os.path.join(path_to_gdb, "F306_Corrente_UTM23S"), None, os.path.join(path_local, "LAYOUT_250_306_" + sigla_var + ".mxd"), False],
    #["F323_Sao_Felix_do_Araguaia", os.path.join(path_to_gdb, "F323_Sao_Felix_do_Araguaia_UTM22S"), None, os.path.join(path_local, "LAYOUT_250_323_" + sigla_var + ".mxd"), False],
    #["F324_Gurupi", os.path.join(path_to_gdb, "F324_Gurupi_UTM22S"), None, os.path.join(path_local, "LAYOUT_250_324_" + sigla_var + ".mxd"), False],
    #["F325_Dianopolis", os.path.join(path_to_gdb, "F325_Dianopolis_UTM23S"), None, os.path.join(path_local, "LAYOUT_250_325_" + sigla_var + ".mxd"), False],
    #["F326_Formosa_do_Rio_Preto", os.path.join(path_to_gdb, "F326_Formosa_do_Rio_Preto_UTM23S"), None, os.path.join(path_local, "LAYOUT_250_326_" + sigla_var + ".mxd"), False],
    #["F343_Araguacu", os.path.join(path_to_gdb, "F343_Araguacu_UTM22S"), os.path.join(path_to_gdb, "F360_Sao_Miguel_do_Araguaia_UTM22S"), os.path.join(path_local, "LAYOUT_250_343_360_" + sigla_var + ".mxd"), True],
    #["F344_Alvorada", os.path.join(path_to_gdb, "F344_Alvorada_UTM22S"), None, os.path.join(path_local, "LAYOUT_250_344_" + sigla_var + ".mxd"), False],
    #["F345_Arraias", os.path.join(path_to_gdb, "F345_Arraias_UTM23S"), None, os.path.join(path_local, "LAYOUT_250_345_" + sigla_var + ".mxd"), False],
    #["F346_Barreiras", os.path.join(path_to_gdb, "F346_Barreiras_UTM23S"), None, os.path.join(path_local, "LAYOUT_250_346_" + sigla_var + ".mxd"), False],
    #["F361_Porangatu", os.path.join(path_to_gdb, "F361_Porangatu_UTM22S"), None, os.path.join(path_local, "LAYOUT_250_361_" + sigla_var + ".mxd"), False],
    ["F362_Campos_Belos", os.path.join(path_to_gdb, "F362_Campos_Belos_UTM23S"), None, os.path.join(path_local, "LAYOUT_250_362_" + sigla_var + ".mxd"), False]
